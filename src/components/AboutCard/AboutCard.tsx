        ...
        <>
            <Card>
                ...
                <Card.Body className="text-justify">
                    ...
                    <p>
                        O blog é constituído de três páginas: a página 'Home' (onde apresento a solução objetivo das tarefa), a página 'Sobre o Projeto' (onde descrevo o problema, os serviços disponibilizados, a descrição da solução e as dificuldades enfrentadas) e uma página de contato (onde é possível encaminhar mensagem para meu email pessoa com críticas, sugestões, elogios ou a esperada mensagem de aprovação no processo ... kkk).
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        Em relação à imagem de fundo, a tela de postagem e a tela sobre o projeto rendeuram uma pesquisa para achar uma solução que contemplasse a rolagem sem perder a imagem e que não causasse conflito com a página de contatos. Por isto a implementação do MasterPage.scss.
                    </p>
                    </Card.Text>
                </Card.Body>
            </Card>
